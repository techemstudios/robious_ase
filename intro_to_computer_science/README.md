...
Start Circuit Coder. Walk students through the app, then challenge them to create connections to make the logic gate, AND, OR, then NOT. As a final challenge have students combine each gate to we have learned to form a basic circuit.  

Note: If the app does not work, continue with LightBot, where they left off.  
